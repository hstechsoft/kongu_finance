...
$conn = new mysqli("srv1002.hstgr.io", "u333142350_kongufinance", "W&n7tE&#Gm[H?k64", "u333142350_kongufinace");
        ...
        <body>
            <script>
                Swal.fire({
                    ...
                    window.location.href = 'https://kongufinance.hstechsoft.com/employeeLogin.html';
                });
            </script>
        </body>
        </html>";
